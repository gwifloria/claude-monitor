...
curl -L "https://github.com/gwifloria/claude-monitor/archive/refs/tags/v0.1.0.tar.gz" -o claude-monitor-0.1.0.tar.gz
...
# 4. 更新 SHA256
curl -L "https://github.com/gwifloria/claude-monitor/archive/refs/tags/v0.2.0.tar.gz" | shasum -a 256
...
**提示**: 将 `gwifloria` 替换为你的 GitHub 用户名！
